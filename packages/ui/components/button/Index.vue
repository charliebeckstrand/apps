...
const backgroundVariants: Record<Variant, Record<Color, string>> = {
	default: {
...
const borderRadius: Record<BorderRadius, string | undefined> = {
	sm: 'rounded-sm',
	md: 'rounded-md',
	lg: 'rounded-lg',
	full: 'rounded-full',
...
const textVariants: Record<Variant, Record<Color, string>> = {
	default: {
...
const borderRadiusClasses = computed<string | undefined>(() =>
	props.icon ? 'rounded-full justify-center' : borderRadius[props.rounded]
)

const backgroundColorClasses = computed<string | undefined>(() =>
	props.color ? backgroundVariants[props.variant][props.color] : undefined
)
...
const textColorClasses = computed<string | undefined>(() => {
	if (props.textColor) {
		return textVariants[props.variant][props.textColor]
	}

	if (props.color) {
		return textVariants[props.variant][props.color]
	}
